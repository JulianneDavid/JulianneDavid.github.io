...
- Leveraging sample-paired short- and long-read RNA sequencing data from the [SRA](https://www.ncbi.nlm.nih.gov/sra) to evaluate short-read intron retention calling.
